-- =====================================================
-- SEED DATA - MERIDIAN INSURANCE
-- Arquivo executado automaticamente após migrações
-- Data: 2025-09-15
-- =====================================================
...
-- Usuários sem KYC (novos cadastros)
...
UNION ALL
SELECT 'Products inseridos:', COUNT(*) FROM products
UNION ALL
SELECT 'Policies inseridas:', COUNT(*) FROM policies
UNION ALL
SELECT 'Payments inseridos:', COUNT(*) FROM payments
UNION ALL
SELECT 'Ledger events inseridos:', COUNT(*) FROM ledger
UNION ALL
SELECT 'Claims inseridos:', COUNT(*) FROM claims
UNION ALL
SELECT 'Webhook logs inseridos:', COUNT(*) FROM webhook_logs;